...
class SaveImageInBackgroundTask extends AsyncTask<Void, Void, Void> {
    ...
    private static final String SCREENSHOT_ID_TEMPLATE_APPNAME = "Screenshot_%s_%s";
    ...
    SaveImageInBackgroundTask(Context context, SaveImageInBackgroundData data,
        ...
        if (!onKeyguard && appName != null) {
            ...
            mScreenshotId = String.format(SCREENSHOT_ID_TEMPLATE_APPNAME, UUID.randomUUID(),
                    appNameString);
        } else {
    ...
    private void startAnimation(final Consumer<Uri> finisher, int w, int h,
        ...
        mScreenshotLayout.post(new Runnable() {
            ...
            public void run() {
                ...
                if (Settings.System.getInt(mContext.getContentResolver(), Settings.System.SCREENSHOT_SOUND, 0) == 1) {
